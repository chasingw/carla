...
#include "RayCastCustomLidar.generated.h"

/// A ray-cast based Lidar sensor.
UCLASS()
class CARLA_API ARayCastCustomLidar : public ARayCastCustomSemanticLidar
{
  GENERATED_BODY()
...
public:
  ...
  ARayCastCustomLidar(const FObjectInitializer &ObjectInitializer);
