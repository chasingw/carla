...
#include "RayCastCustomSemanticLidar.generated.h"

/// A ray-cast based Lidar sensor.
UCLASS()
class CARLA_API ARayCastCustomSemanticLidar : public ASensor
{
  GENERATED_BODY()
...
public:
  ...
  ARayCastCustomSemanticLidar(const FObjectInitializer &ObjectInitializer);
